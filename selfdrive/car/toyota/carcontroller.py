...
MAX_STEER_TORQUE = 1200  # 1500 units is about 2.0 m/s^2 on RAV4 2023
MAX_DRIVER_TORQUE_ALLOWANCE = 150  # slightly above steering pressed allows some resistence when changing lanes which is desirable
